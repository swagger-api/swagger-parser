...
public class OpenAPIV31ParserFullResolveFullyTest {
    ...
    public void testFull() throws Exception {
        ...
        org.testng.Assert.assertEquals(Yaml31.pretty(swaggerParseResult.getOpenAPI()), FileUtils.readFileToString(new File("src/test/resources/3.1.0/dereference/full/dereferencedfully.yaml")));
    }
}
